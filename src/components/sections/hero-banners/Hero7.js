                ...
                <div className="herobanner__content__wrapper herobanner__content__wrapper--2">
                  {type === 2 ? (
                    ...
                    <div className="herobanner__small__text">
                      <span className="text__gradient">Sprit of Mammas</span>
                    </div>
                  )}
  ...
  The Spirit of Mamma&apos;s Love
                  ...
                  <div className="herobanner__text herobanner__text--2">
                    ...
                    <span className="text__gradient">
                          ...
                          Transforming communities through sustainable empowerment while caring for our environment

</p>
                  </div>
                  <div className="herobanner__button">
                    <ButtonPrimary
                     className="herobanner__text herobanner__text--2"
                    ...
                    <div className="video__button">
                      ...
                      <span className="video__button__text"> Watch Video</span>
                    </div>
                  </div>
                </div>
              </div>
