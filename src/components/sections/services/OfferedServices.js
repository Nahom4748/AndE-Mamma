            ...
            <div className="section__title text-center sp_bottom_90">
              {service === 2 ? (
                <div className="section__title__button">
                  <span>Core Value - Spirit of Mamma’s Love</span>
                </div>
              ) : (
                ""
              )}
              ...
              <div className="section__title__text">
                <p>
                AndE Mamma embodies values of Empowerment, Caring, and Life-Giving, ensuring every project supports struggling mammas and nurtures our planet.                </p>
              </div>
            </div>
          </div>
        </div>
