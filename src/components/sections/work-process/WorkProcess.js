  ...
  const items = [
    {
      ...
      desc: "We create new jobs and markets for mothers who need help. We train them to make crafts and help them sell their work. Our Spirit of Mamma's Love project helps 1,050 mothers earn money and learn new skills.",
      duration: 1500,
      path: "/services",
    ...
    },
    {
      id: 2,
      title: "Green Planet",
      desc: "We care deeply about our planet. We find ways to reuse materials and reduce waste while creating jobs. Our projects help the environment and create new chances for mothers to earn a living.",
      duration: 2100,
      path: "/projects",
    ...
    },
    {
      id: 3,
      title: "Great Service",
      desc: "We work with partners to make Ethiopian lives better. We listen to what our customers and partners need, and create services that go above and beyond what they expect.",
      duration: 2700,
      path: "/projects",
          ...
          >
            <div className="section__title section__title--3 text-center sp_bottom_70">
              ...
              <div className="section__title__heading">
                <h3>
                  {type === 2 ? "What We Believe" : "What We Believe"}
                </h3>
              </div>
            </div>
          </div>
